...
public interface ConstraintValidator {
     ...
     */
    public void validate(ProcessingEnvironment procEnv, RoundEnvironment roundEnv, TypeElement constraintedAnnotationType, AnnotationMirror constraintAnnotation, Element constraintedElement);
}
